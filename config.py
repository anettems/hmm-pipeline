...
# Sara - study path and processed path (different that studypath)
study_path = "/projects/sci_meg/data/"  # Biomag scimeg
processed_path = "/projects/HMM-beta/HMM_beta_sara/"  # Biomag HMM-MAR
...
processed_dir = os.path.join(processed_path, "processed/")

# Individual MRI directory
subjects_dir = os.path.join(data_path, 'mri_freesurfatut/')
